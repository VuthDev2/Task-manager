        ...
        <div className="max-w-4xl grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 space-y-6">
            <div className="bg-white p-8 rounded-[2.5rem] shadow-sm flex flex-col items-center text-center border border-white">
              ...
              <h2 className="font-bold text-lg text-gray-900">{profile.full_name || 'Admin'}</h2>
            ...
            <div className="bg-purple-600 p-6 rounded-[2rem] text-white shadow-lg shadow-purple-200">
              <div className="flex items-center gap-3 mb-2">
                <ShieldCheck size={20} />
                <span className="font-bold text-sm">Admin Privileges</span>
              </div>
